 ...
 * BackupFolder.java
 *
 * Created on Oct 15th, 2020, 11:58:41 AM
 */
package com.forms;
...
//              swinghelper.SwingUtilities.setScreenCenter(this);
    ...
    private void initComponents() {
        ...
        jTableDisplay1.setFont(new java.awt.Font("Verdana", 0, 10)); // NOI18N
...
new SwingWorker() {
            ...
            protected Object doInBackground()  {
                 ...
                 int selRow = jTableDisplay1.getSelectedRow();
                 if(selRow==-1){
                 JOptionPane.showMessageDialog(null, "Error", "Please Select a file to download", JOptionPane.ERROR_MESSAGE);
...
MainForm.jProgressBar1.setIndeterminate(true);
        ...
        try {
            ...
            if(i==0){
                 JOptionPane.showMessageDialog(null, "Error in decryption. Please re-check your key with Distributor.", "Error in Code",JOptionPane.ERROR_MESSAGE);
                return null;
            }else if(i==1){
                 JOptionPane.showMessageDialog(null, "Error occured while reading file .", "Error in reading", JOptionPane.ERROR_MESSAGE);
                return null;
            }
