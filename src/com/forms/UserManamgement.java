    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
          ...
          if (jComboBox1.getSelectedIndex()==-1) {
                    JOptionPane.showMessageDialog(null, "Error", "Please Select an Agent to block!!", JOptionPane.ERROR_MESSAGE);
                    return;

                }

        String agentId=getUserId(jComboBox1.getSelectedItem().toString());
        String reason=jTextArea1.getText();

        if(reason.trim().length()==0){
           JOptionPane.showMessageDialog(null, "Error", "Please enter the rejection remarks",JOptionPane.ERROR_MESSAGE);
            return;
        }


        String sql="update userinfo set ActiveFlag='2' where userid  ="+agentId;
int rows=ConnectionManager.executeUpdate(sql, (Object) null);        

        if(rows>0){
            JOptionPane.showMessageDialog(null, "Success!!", "Agent has been blocked", JOptionPane.INFORMATION_MESSAGE);
            try{
...
e.printStackTrace();;
             ...
             JOptionPane.showMessageDialog(null, "Error while blocking the agent!!", "Error", JOptionPane.ERROR_MESSAGE);
