 ...
 * BackupFolder.java
 *
 * Created on Oct 26th, 2020, 11:58:41 AM
 */
package com.forms;
...
//          jd=(MainForm) this.getParent().getParent();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null, "Error", "Please Select City", JOptionPane.ERROR_MESSAGE);
            return;
        ...
        {
            JOptionPane.showMessageDialog(null, "Error", "Please enter the file description.", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if (success)
        {
            JOptionPane.showMessageDialog(null, "Success!!", "Request has been sent", JOptionPane.INFORMATION_MESSAGE);
        } else
        {
            JOptionPane.showMessageDialog(null, "Please wait!", "sending request !!", JOptionPane.INFORMATION_MESSAGE);
        }
